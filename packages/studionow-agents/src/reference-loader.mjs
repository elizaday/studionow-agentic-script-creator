...
const REFERENCE_MAP = {
  ...
  strategy: ["04_script_engines.md", "13_examples_index.md", "15_story_arc_system.md"],
  voice: ["05_voice_and_language.md", "08_tone_system.md"],
  format: ["06_client_script_output.md", "07_producer_notes_output.md"],
  localization: ["09_localization_systems.md"],
  production: ["10_production_reality.md", "14_music_direction.md"],
  critique: ["11_self_critique.md", "12_gotchas.md", "13_examples_index.md"]
};
